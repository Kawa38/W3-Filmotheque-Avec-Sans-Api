...
class Films {constructor(titre, qui, totalD, visioD, description,image,bandeAnnonce ){
   ...
   // piste d'amélioration : intégrer une méthode pour calculer les % de visualisation des films plutôt qu'utiliser une simple fonction
}
}
...
new Films ("Le garçon qui dompta le vent  ", "réalisateur2", 113, 0, "Après avoir lu un livre de science, Willima Kamwamba, un adolescent de 13 ans, fabrique une éolienne et sauve son village malawite de la famine. Inspiré de faits réels. ","./images/Film2.jpg",'<iframe width="560" height="315" src="https://www.youtube.com/embed/msUcT9cRUrM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'),
